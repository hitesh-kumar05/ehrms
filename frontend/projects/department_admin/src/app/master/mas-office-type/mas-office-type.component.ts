...
@Component({
  selector: 'app-mas-office-type',
  templateUrl: './mas-office-type.component.html',
  styleUrl: './mas-office-type.component.scss'
})
export class MasOfficeTypeComponent implements OnInit {///////////////step1////////////////
  mainForm!: FormGroup;   
  ...
  ngOnInit(): void {////////////step 2 method intialize///////////////
  ...
  createForm() {                ///////////////////step4/////////////////////
    this.mainForm = this.fb.group({
      ...
      office_type_name_en: ['', [Validators.required, Validators.pattern('[A-z, ]{1,}')]],
      office_type_name_hi: ['', [Validators.required]],
  ...
  addOfficeType() {                 ///////////////////step5/////////////////////
    console.log(this.mainForm.value)
      ...
      const sub = this.http.postData('/dept/post/saveOfficeTypeDetails/', this.mainForm.value, 'dept').subscribe(res => {
        if (!res.body.error) {
